...
class NavUtils {
  ...
  static void withStateContext(void Function(BuildContext context) run) {
  ...
  static void withOverlayContext(void Function(BuildContext context) run) {
  ...
  static T? runContext<T>(T? Function(BuildContext context) run) {
    final context = rootNavigatorKey.currentContext;
    if (context != null && context.mounted) {
      return run(context);
    }
