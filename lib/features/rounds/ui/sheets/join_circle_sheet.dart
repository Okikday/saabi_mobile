...
void showJoinCircleSheet(BuildContext context) {
  showFSheet(
    context: context,
    side: FLayout.btt,
    builder: (context) => const _JoinCircleSheet(),
  );
}
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Join a Circle', style: Theme.of(context).textTheme.titleLarge?.copyWith(
              color: context.theme.colors.foreground, fontWeight: FontWeight.w700)),
            const SizedBox(height: 8),
            Text('Enter the invite code from a circle admin.', style: Theme.of(context).textTheme.bodySmall?.copyWith(
        ...
        children: [
          Row(
            children: [
              ...
              Text('Circle Found', style: Theme.of(context).textTheme.labelMedium?.copyWith(
                color: const Color(0xFF4CAF50), fontWeight: FontWeight.w700)),
            ],
          ),
          const SizedBox(height: 12),
          Text('NextGen Savings Circle', style: Theme.of(context).textTheme.titleSmall?.copyWith(
            color: context.theme.colors.foreground, fontWeight: FontWeight.w600)),
          const SizedBox(height: 4),
          Text('8 of 10 slots filled • ₦25,000/week', style: Theme.of(context).textTheme.bodySmall?.copyWith(
            color: context.theme.colors.mutedForeground)),
          const SizedBox(height: 12),
          GestureDetector(
            onTap: onJoin,
            child: Container(
              ...
              child: Text('Join Now', style: Theme.of(context).textTheme.labelMedium?.copyWith(
