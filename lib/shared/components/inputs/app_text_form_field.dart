...
import 'package:saabi_mobile/shared/components/layout/app_text.dart';
...
class AppTextFormField extends StatelessWidget {
  ...
  TextFormField _buildTextFormField(TextTheme textTheme) {
    return TextFormField(
      ...
      style: textTheme.labelLarge?.copyWith(color: AppColors.primaryColorA900),
      autofillHints: autofillHints,
      autocorrect: autocorrect,
      autofocus: autofocus,
      autovalidateMode: autovalidateMode ?? (validator == null ? null : AutovalidateMode.onUserInteraction),
      ...
      decoration: InputDecoration(
        ...
        errorText: errorText,
        error: error,
        hintStyle: textTheme.labelLarge?.copyWith(color: AppColors.neutralBlack100),
...
class _TextSelectionToolbarContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      ...
      child: child,
    ).animate().scaleXY(duration: 400.inMs, curve: KCurves.defaultIosSpring, begin: 0.9).slideY(begin: -0.05);
  }
}
